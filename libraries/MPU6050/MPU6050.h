...
class AccelReading{
    ...
    void Initialize();
    void Read();
    double UpdateAverageX (double newvalue);
    double UpdateAverageY (double newvalue);
    double UpdateAverageZ (double newvalue);
    ...
    const unsigned numReadings =NUMREADINGS;
    double accelx[NUMREADINGS];
    double accely[NUMREADINGS];
    double accelz[NUMREADINGS];
    double totalx=0;
    double totaly=0;
    double totalz=0;
    int indexx = 0;
